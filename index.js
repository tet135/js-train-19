...
const Book = {
    ...
    author: "Анонім",
    pages: 0,
    read: function () {console.log(`Ви читаєте ${this.title} від ${this.author}`)},
};
...
Object.defineProperty(ScienceBook, "info", {
    set(value) {
        ScienceBook._info = value;
    },
    get() {
        return `Про книгу "${this.title}": ${this._info}`;
    }
});
ScienceBook.info = "Це довідник з елементарної фізики";
...
// Object.defineProperties(Textbook, {?????????????????????????????????????????
//     title: "Фізика у Вищій Школі",
//     author: "Дж. Д. Джонс",
// });
